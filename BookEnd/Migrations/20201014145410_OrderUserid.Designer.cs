...
namespace BookEnd.Migrations
{
    ...
    [Migration("20201014145410_OrderUserid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookEnd.Models.OrdeeDetails", b =>
                {
                    ...
                    b.ToTable("OrdeeDetails");
                });

            modelBuilder.Entity("BookEnd.Models.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookEnd.Models.OrdeeDetails", b =>
                {
                    b.HasOne("BookEnd.Models.BookStor", "BookStor")
                        .WithMany("OrdeeDetails")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BookEnd.Models.Order", "Order")
                        .WithMany("OrdeeDetails")
